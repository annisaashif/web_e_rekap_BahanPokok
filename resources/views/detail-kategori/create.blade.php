    ...
    <div class="container">
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">Tambah Harga {{ $kategori->nama_komoditi }}</h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                                ...
                                <div class="card-body">
                                        ...
                                        <select class="form-select" id="kabupatenSelect" name="kabupaten_id" required>
                                            ...
                                            @foreach ($kabupaten as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == old('kabupaten_id') ? 'selected' : '' }}>
                                                    {{ $item->nama_kabupaten }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control form-control-lg" name="tanggal"
                                            id="tanggalInput" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                            required />
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-lg" min="1"
                                            name="harga" id="hargaInput" placeholder="Rp." value="{{ old('harga') }}"
                                            required />
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="keteranganTextarea" name="keterangan" placeholder="Keterangan" rows="5">{{ old('keterangan') }}</textarea>
                                    </div>
                                </div>
                                <div class="card-footer d-flex justify-content-end">
                                    <button type="submit" class="btn btn-success">Submit</button>
                                    <a href="{{ route('detail.index', $kategori->id) }}"
